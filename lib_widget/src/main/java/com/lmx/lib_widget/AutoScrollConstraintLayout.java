...
/**
 * created by lmx on 2020/7/5
 * describe： :仿小红书登陆页面背景图无限滚动 ConstraintLayout
 * 功能特点：
...
public class AutoScrollConstraintLayout extends ConstraintLayout {
    /**
     * 滚动方向
     * 0:往上滚出
     * 1:往下滚出
    ...
    public AutoScrollConstraintLayout(@NonNull Context context) {
        this(context, null, 0);
    }

    public AutoScrollConstraintLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoScrollConstraintLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
